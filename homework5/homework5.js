...
<body>
<input type="button" id="hider" value="Нажмите, чтобы спрятать текст" onclick="hiden()" />
<div id="text">Текст</div>
<script>
    let div = document.body.querySelector('div')
    let hiden = ()=> {div.style.visibility="hidden"}
</script>
</body>
</html>
...
4! = 4 * 3 * 2 * 1 = 24
5! = 5 * 4 * 3 * 2 * 1 = 120
Задача – написать функцию factorial(n), которая возвращает n!, используя рекурсию. alert( factorial(5) ); // 120
